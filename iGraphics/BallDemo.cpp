...
void iSpecialKeyboard(unsigned char key)
{
	...
	if(key == GLUT_KEY_LEFT)
	{
		...
		flag=1;
		f=-1;
		if(straight ==1){temp=a;a=b;b=temp;temp=c;c=d;d=temp;}
		straight=0;
...
void solidsnake(){
	...
	if(flag==1){snake_x+=f;sx1=snake_x-30;}
	if(flag==0){snake_y+=f;sx1=snake_x;
							sy1=snake_y-15;}
